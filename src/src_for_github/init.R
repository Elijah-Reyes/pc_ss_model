...
## ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
##
## Function that makes the population. Resulting popualtion is a list
...
make.pop <- function(prms) {
    ...
    traits <- rbind(c(prms$male.sex.inits[1], prms$male.care.inits[1], prms$female.sex.inits[1], prms$female.care.inits[1], 0), 
                    c(prms$male.sex.inits[2], prms$male.care.inits[2], prms$female.sex.inits[2], prms$female.care.inits[2], 10))
